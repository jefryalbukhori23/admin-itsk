                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <div class="col-12 text-center mb-4">
                                <img src="{{ asset('style/assets/img/auth-404.svg') }}" class="w240 mb-4" alt="" />
                                <h1 class="display-1">404</h1>
                                <h5>OOP! PAGE NOT FOUND</h5>
                                <span class="text-muted">Sorry, the page you're looking for doesn't exist. if you think something is broken, report a problem.</span>
                            </div>
