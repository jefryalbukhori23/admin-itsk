        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <h2>Data Jenjang</h2>
                    <br>
                    <b class="text-muted">*Jenjang yang tidak bisa dihapus dikarenakan ada prodi di dalam fakultas tersebut</b>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah jenjang</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="recipient-name" class="form-label">Nama jenjang</label>
                    <input type="text" class="form-control" id="name" placeholder="Masukan Nama jenjang">
                </div>
            </div>
...
<div id="edit_modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Edit jenjang</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_edit" placeholder="Masukan Nama jenjang" readonly>
                </div>
            </div>
            <div class="modal-footer">
...
<div id="detail_modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Prodi per jenjang</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
    ...
    $(document).ready(function(){
        ...
        $("body").on('click','.save_data',function(){
            ...
            if(name == ""){
                ...
                var url_save = '{{route('jenjang.store')}}';
                $.ajax({
                    type : 'POST',
                    url : url_save,
                    data : {
                    ...
                    success:function(response){
                        ...
                        swal.fire({
                            icon: 'success',
                            title: 'Data jenjang berhasil ditambahkan !'
                        });
        ...
        $("body").on('click','.edit',function(){
            var id = $(this).val();
            var url_detail = "{{ route('jenjang.show', ':id') }}";
        ...
        $("body").on('click','.update',function(){
            // alert('tes');
            var id = $("#id_edit").val();
            var url_update = "{{ route('jenjang.update', ':id') }}";
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    swal.fire({
                        icon: 'success',
                        title: 'Data jenjang berhasil diupdate !'
                    });
                    $('#tabel').DataTable().ajax.reload();
        ...
        $("body").on('click','.hapus',function(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var id = $(this).val();
                    var url_delete = "{{ route('jenjang.destroy', ':id') }}";
