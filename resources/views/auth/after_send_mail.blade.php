                    ...
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
                        <div style="max-width: 25rem;">
                            ...
                            <ul class="list-unstyled mb-5">
                                <li class="mb-4">
                                    <span class="d-block mb-1 fs-4 fw-light">Email Terkirim</span>
                                    <span class="color-600">
                                        Silahkan cek kotak masuk email anda, <br>
                                        Kami sudah mengirimkan Email untuk penggantian Password
                                    </span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <a href="index.html" title=""
                                        class="btn btn-lg btn-block btn-dark lift text-uppercase">Verify my account</a>
                                </div> --}}
                                <div class="col-12 text-center mt-4">
